...
明确的上链治理通常被吹捧为具有几个主要优势。 首先，与比特币所倡导的高度保守的哲学不同，它可以迅速发展并接受所需的技术改进。 其次，通过创建一个_explicit_分散的框架，它可以避免被认为是非常不稳定并且容易出现连锁分裂，或者容易变得过于事实上集中化的非正式治理的陷阱 - 后者与1972年着名论文中的论点相同http://www.jofreeman.com/joreen/tyranny.htm
